          ...
          ...MathOperation.values.map((op) {
            ...
            return Card(
              ...
              child: SwitchListTile(
                value: active,
                onChanged: (_) => context.read<GameContentController>().toggleOperation(roomId, op),
              ...
              child: Column(
                children: [
                  ...
                  Slider(
                    ...
                    onChanged: (v) => context.read<GameContentController>().setMathMaxNumber(roomId, v.round()),
                  ),
                ],
              ),
            ),
